		...
		return (
			...
			>
				{columnData.minimized ? (
					<div className={`taskBoardColumnSecHeaderTitleSecColumnCount ${isAdvancedFilterApplied ? 'active' : ''}`} onClick={(evt) => openColumnMenu(evt)} aria-label={t("open-column-menu")}>{localTasks?.length ?? 0}</div>
				) : (
