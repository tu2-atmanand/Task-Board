const en: Lang = {
	...
	"tasks-cache-file-path-description-2": "If you sync the plugin setting as well, then there is no need to change the default path, you can leave this setting empty.",
