const en: Lang = {
	...
	"dfp-methodology-description-1": "This is a new methodology developed to manage and plan small to large projects using the power of visual live canvas, by making use ofdigital tools. Task board is first to implement the full potential of this methodology using this map view feature.",
	...
	"render-only-visible-nodes-description-2": "Disabled: The map loading will take some time to load all the nodes giving you a smoother experience while panning.",
	"controls": "Controls",
