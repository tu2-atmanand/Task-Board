const en: Lang = {
	...
	"task-description-texarea-placeholder":
		"Edit or add description for the task or add more sub-tasks.",
	...
	"confirm-task-delete-description":
		"Are you sure you want to delete this task?",
	yes: "Yes",
	no: "No",
	"scan-tasks-from-the-vault": "Scan tasks from the vault",
	"scan-tasks-from-the-vault-description-1":
		"Run this feature only if your tasks has not been properly detected/scanned or the board is acting weired.",
	"scan-tasks-from-the-vault-description-2":
		"You dont have to run this feature often, the plugin will auto detect newly added/edited tasks.",
	"scan-tasks-from-the-vault-description-3":
		"NOTE : Please check your 'filters for scanning' from the plugin settings first, if you are scanning to detect undetected tasks.",
	...
	"enter-the-value-of-width-for-each-column":
	...
	"auto-add-due-date-to-tasks-info":
		"When enabled, if you add a task using the 'add new task' pop-up window, then today's date will be added as due date, if no date is entered.",
	"auto-scan-the-vault-on-obsidian-startup":
		"Auto scan the vault on Obsidian startup",
	"auto-scan-the-vault-on-obsidian-startup-info":
		"Only use this feature if you edit the vault files outside Obsidian. Usually all your newly added/edited tasks will be detected automatically.",
	"auto-scan-the-vault-on-obsidian-startup-info-2":
		"If your vault contains lot of files with huge data, this might affect the startup time of Obsidian.",
	"compatible-plugins": "Compatible plugins",
	"plugin-compatibility": "plugin compatibility",
	"day-planner-plugin-compatibility":
		"If you have installed 'day planner' plugin, enable this to see the time at the start of the task title, instead in the metadata. After enabling this feature, the time will be shown according to the day planner plugin inside Markdown files, but in the task card, the time will be shown in the footer as usual.",
	"daily-notes-plugin-compatibility":
		"When enabled, if you add a task in a daily-note file, which has a file name in format like 'yyyy-MM-DD'. Then this date will be considered as the due date for the task.",
	...
	"task-completion-in-local-time-info":
		"Whether task completion date-time should be shown in local time",
	...
	"plugin-language-info":
		"Select the language of the plugin UI. To contribute for improving the current language or to add your own native language, please refer the docs.",
	...
	"no-active-editor-is-open-error-notice":
		"No active editor is open. Please place your cursor inside editor where you want to add task and run this command.",
	...
	"automation-section-description":
		"This section contains the settings to automate certain tasks for an efficient workflow, so you can spend more time on your project than tasks management.",
	note: "Note",
	"format-section-description":
		"This section contains the settings to adjust the formats you use for creating tasks.",
	none: "NONE",
	highest: "Highest",
	high: "High",
	medium: "Medium",
