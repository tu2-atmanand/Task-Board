const en: Lang = {
	...
	"Default note for new tasks": "Default note for new tasks",
	...
	"note-for-archived-tasks": "Note for archived tasks",
	"note-for-archived-tasks-description": "Select the note in which the archived tasks should be moved. Leave this setting empty to simply comment out the task in the parent file itself",
