const en: Lang = {
	...
	"scan-vault-modal": "Vault scanner",
	"general": "General",
	...
	"scanning-mode-info": "Select the scanning mode you would like Task Board to use :",
	"balanced": "Balanced",
	"balanced-scanning-mode-info": "The modified files will be scanned once you have finished editing them and when you will be switching the tab or window.",
	"manual": "Manual",
	"manual-scanning-mode-info": "You will be required to click on the refresh button when you would like to see the latest content on the board. The refresh button will shown an indicator.",
	"real-time": "Real-time",
	...
	"date-format-info-note": "If you are using inline-tasks, then please note that, this plugin dont scan all kinds of format at present. For example, if there are spaces as a seperater (2026 01 01), then this plugin might fail to scan the date value properly, even though the format is shown as valid here. But, it will work for task-notes",
	"date-time-format-info": "Enter the date-time format which will be used while adding a date-time value to the specific task properties. In the current version, only completion-date and cancelled-date properties will get a date-time value, but in the future it will be possible to configure other date type properties to have a date-time value.",
	...
	"open-scan-vault-modal": "Open vault scanner",
	"new-board": "New board",
	"are-you-sure": "Are you sure?",
	"reminder-label": "Reminder",
	"tag-color-indicator-type": "Tag color indicator type",
	"tag-color-indicator-type-info": "Select how the below tag colors should be used. Based on this setting, the tag color will be applied to either the tag's text, tag pill or the whole card background.",
	"text-of-the-tag": "Tag text",
	"tag-background": "Tag background",
	"background-of-the-card": "Card background",
	...
	"default-note-for-new-tasks-description": "Select the default note in which all the newly added tasks through 'task editor' should be saved.",
	...
	"auto-add-created-date": "Auto add created date",
	"auto-add-created-date-desc": "When enabled, todays date will be automatically added as the created date to the task.",
	"auto-add-completed-date": "Auto add completed date",
	"auto-add-completed-date-desc": "Enable this feature to automatically add current date-time value as the completed date property to the task when you will mark the task as complete through checkbox or through status change to status of type 'TODO'",
	...
	"default-quickadd-choice-description": "Select which of your choice from your quickadd plugin configuration should be used as the default choice in the 'task editor'. Please install the quickadd plugin first and create a choice in the quickadd plugin.",
	"quickadd-plugin-not-enabled": "Quickadd plugin is not installed or enabled. Please install the plugin and enable it.",
	"quickadd-plugin-compatibility-description": "If you have installed the quickadd plugin, you can now use its 'choices' from the 'task editor' to directly add the task wherever you want.",
	...
	"update-language-translations-info": "If you have changed the inteface language in Obsidian settinsg, click on the update button to download the latest language translations for that language. You can locally update the translations in your own language and submit your changes to contribute to this plugin. Read more here : ",
	...
	"task-note-identifier-tag-description": "Enter the tag which will be used to indentify a normal task as a task-note. This tag will be automatically added to the tasks created through 'task editor'. Enter without '#'.",
	"default-location-for-new-task-notes": "Folder for new task-notes",
	"default-location-for-new-task-notes-description": "Default folder where new task-notes will be saved. You can also change the location from the 'task editor' while creating a new task-note.",
	...
	"view-filters-for": "View filters for",
	...
	"view-type": "View type",
	"view-type-info": "Select the type of the view you want to add. (More types of views will be added soon...)",
	...
	"task-card-style-info": "Select the UI of the task card. With the 'bases card style' option you may also use an additional CSS snippet to get more dataview properties kind of look.",
	...
	"show-modified-files-message-on-startup-info": "If any of the vault files has been modified when Obsidian was inactive. These modified files will be auto-detected at the application start time, after a 10 second delay. This message will help to get the statistics of which files has been modified. If you disable this setting, the modified files will be auto-scanned without needing your attention.",
	...
	"view-name": "View name",
	"view-name-info": "Give a name to your views to uniquely identify them. You can also change this later.",
	"view-description": "View description",
	"view-description-info": "Describe what this view is about in one or two sentences. This description will be visible inside the board drawer and few other places.",
	...
	"open-board-drawer": "Open board drawer",
	"close-board-drawer": "Close board drawer",
	"panel-options": "Panel options",
	"header-style": "Header style",
	"buttons-belt": "Buttons belt",
	"dropdown": "Dropdown",
	"no-views-in-board": "Looks like there are no views available in this board. Please create a new view from the 'Board configure modal'",
