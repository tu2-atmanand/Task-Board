const es = {
  ...
  103: "Cuando esta opción está habilitada, si agrega una tarea en un archivo de Nota diaria, que tiene un nombre de archivo como \"aaaa-MM-DD\", esta fecha se considerará como la fecha de vencimiento de la tarea.",
  104: "Formato de fecha de vencimiento",
  105: "Introduzca el formato de fecha que está utilizando para nombrar sus archivos de Notas diarias. Utilice \"aaaa-MM-DD\" o \"DD-MM-aaaa\".",
