const fr = {
  ...
  2: "Fermer",
  3: "Archive",
  4: "Ouvrir le tableau des tâches",
  5: "Réanalyser le coffre-fort",
  6: "Aucun fichier actif trouvé pour ajouter une tâche.",
  ...
  29: "Contenu du corps",
  30: "Heure de début de la tâche",
  31: "Heure de fin de la tâche",
  32: "Date d'échéance de la tâche",
  33: "Priorité des tâches",
  34: "Étiquette de tâche",
  35: "Aucun tableau n'a été sélectionné pour être supprimé.",
  36: "Paramètres globaux du plugin",
  37: "Paramètres",
  38: "Nom du conseil d'administration",
  39: "Nom du tableau qui apparaîtra sous forme d'onglet dans l'en-tête de l'onglet à l'intérieur du plugin.",
  40: "Afficher les balises pour les colonnes de type namedTag",
  41: "Fonctionne uniquement pour les colonnes de type namedTag. Si vous ne voulez pas voir la balise sur la carte pour le type de colonne.",
  ...
  49: "S'il faut afficher les balises filtrées mentionnées ci-dessus sur la carte d'élément de tâche.",
  50: "Colonnes",
  51: "Entrer la balise",
  ...
  65: "Tâches d'analyse à partir du coffre-fort",
  ...
  68: "REMARQUE : veuillez d’abord vérifier vos filtres d’analyse de fichiers dans les paramètres du plug-in, si vous exécutez cette fonction pour analyser des tâches non détectées.",
  69: "Courir",
  70: "Masquer les tâches collectées",
  71: "Afficher les tâches collectées",
  72: "Échec du chargement des paramètres.",
  73: "Veuillez lire la documentation pour utiliser efficacement le plugin :",
  74: "Documents du tableau des tâches",
  75: "Filtres pour la numérisation",
  76: "Scannez uniquement ceci",
  77: "Ne pas scanner ceci",
  78: "Désactiver",
  79: "Paramètres de l'interface utilisateur du tableau",
  80: "Afficher l'en-tête de la carte d'élément de tâche",
  81: "Activez cette option pour voir l'en-tête dans la fiche d'élément de tâche",
  82: "Afficher le pied de page de la fiche d'élément de tâche",
  83: "Activez cette option pour voir le pied de page dans la fiche d'élément de tâche",
  ...
  87: "Activez cette option pour afficher une barre de défilement pour chaque colonne. Cela réduira la largeur des cartes de tâches.",
  88: "Couleurs des étiquettes",
  89: "Supprimer",
  90: "Ajouter une couleur d'étiquette",
  91: "Nom de l'étiquette",
  92: "Paramètres d'automatisation",
  93: "Numérisation en temps réel",
  94: "Une fois que vous avez perdu le focus sur le fichier que vous avez modifié, la tâche sera immédiatement actualisée dans le tableau des tâches.\nLa désactivation de ce paramètre analysera les fichiers modifiés après un certain temps.",
  ...
  102: "Si vous avez installé le plugin Day Planner, ce plugin saisit l'heure au début du corps de la tâche, plutôt que dans les métadonnées. Après avoir activé cette fonctionnalité, l'heure sera affichée conformément au plugin Day Planner dans les fichiers Markdown, mais dans le tableau des tâches, l'heure sera affichée dans le pied de page de la tâche.",
  103: "Lorsque cette option est activée, si vous ajoutez une tâche dans un fichier de notes quotidiennes, dont le nom de fichier est « aaaa-MM-JJ », cette date sera alors considérée comme la date d'échéance de la tâche.",
  104: "Format de la date d'échéance",
  105: "Saisissez le format de la date que vous utilisez pour nommer vos fichiers de notes quotidiennes. Veuillez utiliser soit « aaaa-MM-JJ » soit « JJ-MM-aaaa »",
  106: "Formats des dates d'échéance et d'achèvement",
  107: "L'aperçu apparaîtra ici",
  108: "Plugin compatible",
  109: "Différents plugins ont des formats différents pour donner les balises d'échéance et d'achèvement dans la tâche. Veuillez en sélectionner un et voir le format ci-dessus, s'il est compatible avec votre configuration actuelle.",
  110: "Défaut",
  111: "Modèle de date et d'heure d'achèvement de la tâche",
  112: "Saisissez le modèle de date et d'heure que vous souhaitez voir pour la valeur d'achèvement. Par exemple : aaaa-MM-jjTHH:mm:ss",
  ...
  123: "Si les heures d'achèvement des tâches sont affichées en heure locale",
  ...
  126: "Si vous aimez ce plugin, pensez à soutenir mon travail en faisant un petit don pour une amélioration continue de l'idée !",
  127: "Langue du plug-in",
  ...
  135: "Ajouter un fichier dans le filtre « Ne pas analyser ce fichier »",
  136: "Ajouter un fichier dans le filtre « Analyser uniquement ce fichier »",
  137: "Ajouter un dossier dans le filtre « Ne pas analyser ce dossier »",
  138: "Ajouter un dossier dans le filtre « Analyser uniquement ce dossier »",
  ...
  147: "Aucun éditeur actif n'est ouvert. Veuillez placer votre curseur dans l'éditeur et exécuter cette commande.",
};
export default fr;