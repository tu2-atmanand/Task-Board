const fr = {
  ...
  5: "Fenêtre de numérisation du coffre-fort",
  6: "Général",
  ...
  135: "Ajouter un fichier dans le filtre d'analyse",
  136: "Ajouter un fichier dans le filtre d'analyse",
  137: "Ajouter un dossier dans le filtre d'analyse",
  138: "Ajouter un dossier dans le filtre d'analyse",
  ...
  169: "Nom de fichier",
  170: "Vos planches",
  171: "Fichier non trouvé dans le chemin :",
  172: "Mode bouton d'édition",
  173: "Sélectionnez le mode d'ouverture de la note parent. Double-cliquez sur la carte pour ouvrir la note.",
  174: "Utiliser la fonction d’édition de la fenêtre des tâches",
  175: "Ouvrir la note dans un nouvel onglet",
  176: "Note ouverte en split droit",
  177: "Ouvrir la note dans une nouvelle fenêtre",
  178: "Ouvrir une note dans l'aperçu au survol",
};
export default fr;