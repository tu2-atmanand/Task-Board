const pt = {
  ...
  135: "Adicionar arquivo no filtro `Não escanear isto`",
  136: "Adicionar arquivo no filtro `Somente escanear isto`",
  137: "Adicionar pasta no filtro `Não escanear isto`",
  138: "Adicionar pasta no filtro `Somente verificar isto`",
