const ptBR = {
  ...
  "show-tags-in-the-columns-of-type-tagged": "Show tags in 'tagged' type columns",
  "show-tags-in-the-columns-of-type-tagged-info": "Only works for 'tagged' type columns. If you dont want to see the tag on the card for the type of column.",
  "filter-tags": "Filter tags",
  "filter-tags-input-placeholder": "Enter the tags, separated with comma, you want to see in this board. Only tasks with these tags will be shown.",
  ...
  "show-filtered-tags-info": "Whether to show the above mention filtered tags on the 'task card'.",
  columns: "Columns",
  "enter-tag": "Enter tag",
  "max-items": "Max items",
  from: "From",
  ...
  "name-of-the-file-folder-tag-for-filter-info": "Enter the names of the files, folder or tag of the task to control which files you want the plugin to scan to extract tasks from them. Its higly recommended to read the documentation if you are using all three filters at the same time.",
