...
// This function use to basically detach and re-attach whole view of Obsidian, but horrible user Experience.
...
// THis is the only function which use to work smoothly, but its not a good idea to do like below thing, also the below thing refreshing was not smooth, it use to refresh one single column, which was active ofcourse, but it was noticeable.
