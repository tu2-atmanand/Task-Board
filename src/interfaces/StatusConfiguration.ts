import { statusTypeNames } from "./Enums.js";
...
export class StatusConfiguration {
	 ...
	 */
	public readonly type: statusTypeNames;
	...
	constructor(
		...
		type: statusTypeNames = statusTypeNames.TODO, // TODO Remove default value
	) {
		this.symbol = symbol;
		this.name = name;
